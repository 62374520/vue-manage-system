<template>
    <div>
                    ...
                    <template #default="{ row, column, $index }" v-if="!item.type">
                        <slot :name="item.prop" :rows="row" :index="$index">
                            <template v-if="item.prop == 'operator'">
                                <el-link type="primary" style="margin-right: 30px;">查看实体详情</el-link>
                                <el-link type="primary" style="margin-right: 30px;">更新实体信息</el-link>
                                <el-link type="primary" style="margin-right: 30px;">删除实体</el-link>
        ...
        <el-pagination v-if="hasPagination" :current-page="currentPage" :page-size="10" :background="true"
            :layout="layout" :total="25739" @current-change="handleCurrentChange" />
    </div>
</template>
